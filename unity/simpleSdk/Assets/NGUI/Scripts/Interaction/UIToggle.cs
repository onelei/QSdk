...
public class UIToggle : UIWidgetContainer
{
    ...
    /// <summary>
    /// Tween to play on the active sprite,if any
    /// </summary>
    public UITweener activeTween;
    ...
    [HideInInspector]
    [SerializeField]
    protected  bool startsChecked = false; // Use 'startsActive' instead
        ...
        else if (mIsActive != state)
        {
            ...
            else if (activeTween != null)
            {
                if (state)
                    ...
                    activeTween.PlayReverse();
                //ActiveAnimation aa = ActiveAnimation.Play(activeTween, null,
                //    state ? Direction.Forward : Direction.Reverse,
                //    EnableCondition.IgnoreDisabledState,
                //    DisableCondition.DoNotDisable);
                //if (aa != null && (instantTween || !NGUITools.GetActive(this))) aa.Finish();
